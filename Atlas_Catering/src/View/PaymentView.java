...
public class PaymentView {
    ...
    public void addPayment() {
        ...
        System.out.println("Please enter the payment details below:-");
        ...
        InterfaceUtils.continuePrompt("9");
    }
    ...
    //         Payment tempPayment = (Payment)paymentIterator.next();
    //         if(tempPayment.getPaymentID().equals(paymentID)) {
    //             Payment removedPayment = paymentController.removePayment(paymentIterator);
